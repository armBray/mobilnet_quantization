...
arm_status arm_convolve_HWC_int8iq_fast(const uint8_t * Im_in, // MODIFICA q7_t --> uint8_t
...
uint8_t     *arm_nn_mat_mult_kernel_int8iq_q15_reordered(const uint8_t * pA, // (buffer) MODIFICA q7_t --> uint8_t
