 ...
 * int8iq
 */
void      arm_int8iq_to_q15_reordered_no_shift(const q7_t * pSrc, q15_t * pDst, uint32_t blockSize);
 ...
 */
/*
 * N.B.:inizialmente questa funzione aveva questa intestazione
 * __STATIC_FORCEINLINE void *read_and_pad(void *source, q31_t * out1, q31_t * out2)
 * è stata modificata perchè non si conosce il problema
 * */
__STATIC_INLINE void *read_and_pad(void *source, q31_t * out1, q31_t * out2)
{
...
__STATIC_INLINE void *read_and_pad_reordered(void *source, q31_t * out1, q31_t * out2)
{
        q31_t     inA = *__SIMD32(source)++;
#ifndef ARM_MATH_BIG_ENDIAN
 ...
 * MODIFICA
 */
__STATIC_INLINE void *read_and_pad_int8iq_reordered(void *source, q31_t * out1, q31_t * out2)
{
        q31_t     inA = *__SIMD32(source)++;
#ifndef ARM_MATH_BIG_ENDIAN
